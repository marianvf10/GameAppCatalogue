...
export default function Add() {
  ...
  const uploadImage = async()=> {
    ...
    try {
      //descargo la imagen y guardo el link en el objeto
      const setUrl = await ref.getDownloadURL();
      //con esta linea agrego la url al objeto
      setNewItem({ ...newItem, imageUri: setUrl });
